-- 1. First insert users with properly hashed passwords (all passwords are 'password123' but securely hashed)
INSERT INTO app_user (name, email, password) VALUES
('Aarav Sharma', 'aarav@gmail.com', '$2a$10$N9qo8uLOickgx2ZMRZoMy.Mrq4H3dQjLQ5Fj/aB8sGd7GjR4b.FFe'),
...
-- 2. Assign roles to users (RIDER and/or DRIVER)
...
-- 3. Create rider profiles
INSERT INTO rider (id, user_id, rating) VALUES
(1, 1, 4.9);

-- 4. Create driver profiles with Delhi/NCR locations
INSERT INTO driver (id, user_id, rating, available, current_location) VALUES
(2, 2, 4.7, true, ST_SetSRID(ST_MakePoint(77.1025, 28.7041), 4326),   -- Connaught Place
(3, 3, 4.8, true, ST_SetSRID(ST_MakePoint(77.2167, 28.6667), 4326),   -- South Delhi
(4, 4, 4.6, true, ST_SetSRID(ST_MakePoint(77.2273, 28.6353), 4326),   -- Greater Kailash
(5, 5, 4.9, true, ST_SetSRID(ST_MakePoint(77.2500, 28.5500), 4326),   -- Gurugram
(6, 6, 4.3, true, ST_SetSRID(ST_MakePoint(77.2000, 28.6200), 4326),   -- Nehru Place
(7, 7, 4.4, true, ST_SetSRID(ST_MakePoint(77.2800, 28.5900), 4326),   -- Noida
(8, 8, 4.5, true, ST_SetSRID(ST_MakePoint(77.2600, 28.6800), 4326),   -- North Campus
(9, 9, 4.6, true, ST_SetSRID(ST_MakePoint(77.2200, 28.6400), 4326),   -- Saket
(10, 10, 4.7, true, ST_SetSRID(ST_MakePoint(77.2700, 28.6700), 4326); -- East Delhi

-- 5. Initialize wallets with balances
INSERT INTO wallet (id, user_id, balance) VALUES
(1, 1, 1000.00),  -- Rider wallet
(2, 2, 500.00),   -- Driver wallet
(3, 3, 750.00),
(4, 4, 600.00),
(5, 5, 850.00),
(6, 6, 400.00),
